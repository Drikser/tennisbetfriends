                  ...
                  )
                  {
                    ...
                    if ($bonusPrognosis['PROB_VQR'] == '') {
    	                ...
    	                if (strtotime(date('Y-m-d G:H:s')) < strtotime($startDateTournament)) {
    	                	...
    	                	echo "Who will win this 2020 edition?<br />";
                    ...
                    **************************************** MEILLEUR FRANCAIS *****************************************
                    if ($bonusPrognosis['PROB_FR_NOM'] == '') {
    	                ...
    	                if (strtotime(date('Y-m-d G:H:s')) < strtotime($startDateTournament)) {
                          ...
                          echo "According to you which French player will have the best result during this 2020 edition?<br />";
                    ...
                    if ($bonusPrognosis['PROB_FR_NIV'] == '') {
    	                ...
    	                echo "<h2>Level of the best French player</h2>";
                      ...
                      if (strtotime(date('Y-m-d G:H:s')) < strtotime($startDateTournament)) {
    	                // if ($bonusPrognosis['PROB_FR_NIV'] == '') {
                          ...
                          echo "... and what will be his level?<br />";
