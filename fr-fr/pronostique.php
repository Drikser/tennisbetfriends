...
<html>
    ...
    <div id="conteneur">
        ...
        <div class="element_corps" id="corps">
            ...
            <p>
                Choississez si vous souhaitez faire un pronostique général sur le tournoi ou faire un pronostique sur les matchs du tournoi : <br />
            </p>
            ...
            ?>
                ...
                <br /><a href="pronostique_tournoi.php"><h1>Pronostiques du tournoi</h1></a><br />

                <!-- PRONOSTIQUES DES MATCHS -->
                <br /><a href="pronostique_matchs.php"><h1>Pronostiques des matchs</h1><br />
